<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center bg-[#004269] p-4 sm:rounded ">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-red-300">
                            <div class="bg-[#FF0000] text-white px-5 py-3 flex justify-between items-center cursor-pointer rounded-t-xl hover:bg-red-700 transition duration-150" onclick="toggleCard('info-body')">
                        ...
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-[#108E95]">
                            <div class="bg-[#009DA5] text-white px-5 py-3 flex justify-between items-center cursor-pointer rounded-t-xl hover:bg-[#108E95] transition duration-150" onclick="toggleCard('schedule-body')">
                                <h2 class="text-lg font-semibold flex items-center">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-indigo-300 h-full">
                            <div class="bg-[#009DA5] text-white px-5 py-3 flex justify-between items-center rounded-t-xl">
                                <h2 class="text-lg font-semibold flex items-center">
                        ...
                        <canvas id="gpaChart"></canvas>
                            ...
                            <div class="p-5 border-t border-gray-100 bg-gray-50 rounded-b-xl">
                                <p class="text-gray-700 font-medium">Current Cumulative GPA (IPK): <span class="text-2xl font-bold text-[#009DA5]">3.05</span></p>
                            </div>
                        </div>
                    </div>
