<x-guest-layout>
    <div class="flex flex-col lg:flex-row min-h-screen bg-gray-100">
        ...
        <div class="w-full lg:w-1/2 min-h-[50vh] lg:min-h-screen flex items-center justify-center p-6 relative" 
             style="background-image: url('/gambar/gedung.png'); background-size: cover; background-position: center;">
            ...
            <div class="w-full max-w-md bg-white p-6 rounded-xl shadow-2xl relative z-10">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div class="pt-2">
                        <button type="submit" class="submit-button bg-[#042d45ff] hover:bg-[#004269] text-white py-3 px-6 rounded-lg font-bold uppercase tracking-wide shadow-lg w-full transition duration-300">
                            Daftar Sekarang
                        </button>
                    </div>
                    ...
                    <div class="text-center text-sm pt-2">
                        ...
                        <a href="{{ route('login') }}" class="font-medium text-[#004269] hover:underline ml-1">
                            Login disini
                        </a>
                    </div>
                </form>
        ...
        <div class="relative overflow-hidden w-full lg:w-1/2 bg-white shadow-xl shadow-gray-300/40 rounded-2xl flex flex-col justify-center border border-gray-100" id="du">
            ...
            <div class="absolute top-5 left-1 w-24 h-32 opacity-70 z-0" style="background-image: radial-gradient([#004269] 1.5px, transparent 1.5px); background-size: 12px 12px;"></div>
            <div class="absolute bottom-10 right-10 w-24 h-32 opacity-70 z-0" style="background-image: radial-gradient([#004269] 1.5px, transparent 1.5px); background-size: 12px 12px;"></div>
            ...
            <div class="relative z-10 w-full p-10 lg:p-16">
                ...
                <div class="flex justify-between items-start mt-[-80px]">
                    ...
                    <div class="relative z-10">
                        ...
                        <img src="{{ asset('gambar/2.png') }}" class="w-[170px]" onerror="this.style.display='none'">
                    </div>
                </div>

                <h2 class="text-3xl lg:text-4xl font-extrabold text-[#004269] mt-10">
                    Informasi E-Student
                </h2>~
                <p class="text-black leading-relaxed text-justify mt-4">
    ...
    <style>
        ...
        .input-style:focus {
            outline: none;
            border-color: #004269; /* Fokus warna Indigo */
